...
function initializeProfile() {
    ...
    if (profileConfig.location) {
        $('#profile-location').html('<i class="fa fa-map-marker"></i> <span>' + profileConfig.location + '</span>');
    }
